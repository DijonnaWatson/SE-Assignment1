...
public class FibonacciMethod implements FibonacciInterface {
	...
	public int Fibonacci(int numberOfTerms, int firstTerm, int secondTerm) {
		if (numberOfTerms < 3) 
			throw new IllegalArgumentException("The number of terms cannot be less than three.");
		else if(numberOfTerms > 45)
			throw new IllegalArgumentException("The number of terms cannot be greater than forty-five.");
