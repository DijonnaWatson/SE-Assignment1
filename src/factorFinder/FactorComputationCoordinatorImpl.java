  ...
  public FactorComputeResult compute(FactorComputeRequest request) {
    try {
      ...
      if (request.getInputConfig() != null) {
        // Correlates to step 2a. Here we receive requests from the user to
        ...
        for (Integer number : inputData) {
          ...
          // Correlates to step 2d. Request that the data storage component
          // write whatever result to the output
