...
class TestFactorComputeEngine {
    ...
    public void testSetDelimiter() {
        ...
        //Even if we change what's in the setDelimeter's but match them this still works
    ...
    public void prototype(FactorComputeEngineImpl engine) {
        ...
        assertArrayEquals(new int[] {1, 2, 5, 10}, result);  // Verifying the result matches the expected array
    }
}
