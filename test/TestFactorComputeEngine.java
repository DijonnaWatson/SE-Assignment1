...
public class TestFactorComputeEngine {
    ...
    @Mock
    private FactorComputeEngine engine; // Mock the dependency

    @InjectMocks
    private TestFactorComputeEngine testFactorComputeEngine; // The class under test
    ...
    public String prototype(FactorComputeEngine engine) {
        ...
        return Arrays.toString(result); // Assuming you want to return a string representation of the factors
    }
